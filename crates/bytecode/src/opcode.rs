...
opcodes! {$
    ...
    0x60 => PUSH1  => stack::push::<1, _>             => stack_io(0, 1), immediate_size(1);
    0x61 => PUSH2  => stack::push::<2, _>             => stack_io(0, 1), immediate_size(2);
    0x62 => PUSH3  => stack::push::<3, _>             => stack_io(0, 1), immediate_size(3);
    0x63 => PUSH4  => stack::push::<4, _>             => stack_io(0, 1), immediate_size(4);
    0x64 => PUSH5  => stack::push::<5, _>             => stack_io(0, 1), immediate_size(5);
    0x65 => PUSH6  => stack::push::<6, _>             => stack_io(0, 1), immediate_size(6);
    0x66 => PUSH7  => stack::push::<7, _>             => stack_io(0, 1), immediate_size(7);
    0x67 => PUSH8  => stack::push::<8, _>             => stack_io(0, 1), immediate_size(8);
    0x68 => PUSH9  => stack::push::<9, _>             => stack_io(0, 1), immediate_size(9);
    0x69 => PUSH10 => stack::push::<10, _>            => stack_io(0, 1), immediate_size(10);
    0x6A => PUSH11 => stack::push::<11, _>            => stack_io(0, 1), immediate_size(11);
    0x6B => PUSH12 => stack::push::<12, _>            => stack_io(0, 1), immediate_size(12);
    0x6C => PUSH13 => stack::push::<13, _>            => stack_io(0, 1), immediate_size(13);
    0x6D => PUSH14 => stack::push::<14, _>            => stack_io(0, 1), immediate_size(14);
    0x6E => PUSH15 => stack::push::<15, _>            => stack_io(0, 1), immediate_size(15);
    0x6F => PUSH16 => stack::push::<16, _>            => stack_io(0, 1), immediate_size(16);
    0x70 => PUSH17 => stack::push::<17, _>            => stack_io(0, 1), immediate_size(17);
    0x71 => PUSH18 => stack::push::<18, _>            => stack_io(0, 1), immediate_size(18);
    0x72 => PUSH19 => stack::push::<19, _>            => stack_io(0, 1), immediate_size(19);
    0x73 => PUSH20 => stack::push::<20, _>            => stack_io(0, 1), immediate_size(20);
    0x74 => PUSH21 => stack::push::<21, _>            => stack_io(0, 1), immediate_size(21);
    0x75 => PUSH22 => stack::push::<22, _>            => stack_io(0, 1), immediate_size(22);
    0x76 => PUSH23 => stack::push::<23, _>            => stack_io(0, 1), immediate_size(23);
    0x77 => PUSH24 => stack::push::<24, _>            => stack_io(0, 1), immediate_size(24);
    0x78 => PUSH25 => stack::push::<25, _>            => stack_io(0, 1), immediate_size(25);
    0x79 => PUSH26 => stack::push::<26, _>            => stack_io(0, 1), immediate_size(26);
    0x7A => PUSH27 => stack::push::<27, _>            => stack_io(0, 1), immediate_size(27);
    0x7B => PUSH28 => stack::push::<28, _>            => stack_io(0, 1), immediate_size(28);
    0x7C => PUSH29 => stack::push::<29, _>            => stack_io(0, 1), immediate_size(29);
    0x7D => PUSH30 => stack::push::<30, _>            => stack_io(0, 1), immediate_size(30);
    0x7E => PUSH31 => stack::push::<31, _>            => stack_io(0, 1), immediate_size(31);
    0x7F => PUSH32 => stack::push::<32, _>            => stack_io(0, 1), immediate_size(32);

    0x80 => DUP1  => stack::dup::<1, _>               => stack_io(1, 2);
    0x81 => DUP2  => stack::dup::<2, _>               => stack_io(2, 3);
    0x82 => DUP3  => stack::dup::<3, _>               => stack_io(3, 4);
    0x83 => DUP4  => stack::dup::<4, _>               => stack_io(4, 5);
    0x84 => DUP5  => stack::dup::<5, _>               => stack_io(5, 6);
    0x85 => DUP6  => stack::dup::<6, _>               => stack_io(6, 7);
    0x86 => DUP7  => stack::dup::<7, _>               => stack_io(7, 8);
    0x87 => DUP8  => stack::dup::<8, _>               => stack_io(8, 9);
    0x88 => DUP9  => stack::dup::<9, _>               => stack_io(9, 10);
    0x89 => DUP10 => stack::dup::<10, _>              => stack_io(10, 11);
    0x8A => DUP11 => stack::dup::<11, _>              => stack_io(11, 12);
    0x8B => DUP12 => stack::dup::<12, _>              => stack_io(12, 13);
    0x8C => DUP13 => stack::dup::<13, _>              => stack_io(13, 14);
    0x8D => DUP14 => stack::dup::<14, _>              => stack_io(14, 15);
    0x8E => DUP15 => stack::dup::<15, _>              => stack_io(15, 16);
    0x8F => DUP16 => stack::dup::<16, _>              => stack_io(16, 17);

    0x90 => SWAP1  => stack::swap::<1, _>             => stack_io(2, 2);
    0x91 => SWAP2  => stack::swap::<2, _>             => stack_io(3, 3);
    0x92 => SWAP3  => stack::swap::<3, _>             => stack_io(4, 4);
    0x93 => SWAP4  => stack::swap::<4, _>             => stack_io(5, 5);
    0x94 => SWAP5  => stack::swap::<5, _>             => stack_io(6, 6);
    0x95 => SWAP6  => stack::swap::<6, _>             => stack_io(7, 7);
    0x96 => SWAP7  => stack::swap::<7, _>             => stack_io(8, 8);
    0x97 => SWAP8  => stack::swap::<8, _>             => stack_io(9, 9);
    0x98 => SWAP9  => stack::swap::<9, _>             => stack_io(10, 10);
    0x99 => SWAP10 => stack::swap::<10, _>            => stack_io(11, 11);
    0x9A => SWAP11 => stack::swap::<11, _>            => stack_io(12, 12);
    0x9B => SWAP12 => stack::swap::<12, _>            => stack_io(13, 13);
    0x9C => SWAP13 => stack::swap::<13, _>            => stack_io(14, 14);
    0x9D => SWAP14 => stack::swap::<14, _>            => stack_io(15, 15);
    0x9E => SWAP15 => stack::swap::<15, _>            => stack_io(16, 16);
    0x9F => SWAP16 => stack::swap::<16, _>            => stack_io(17, 17);
