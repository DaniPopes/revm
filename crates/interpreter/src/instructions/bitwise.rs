...
pub fn slt(interpreter: &mut Interpreter) {
    gas!(interpreter, gas::VERYLOW);
    pop_top!(interpreter, op1, op2);
    *op2 = U256::from(i256_cmp(&op1, op2) == Ordering::Less);
}

pub fn sgt(interpreter: &mut Interpreter) {
    gas!(interpreter, gas::VERYLOW);
    pop_top!(interpreter, op1, op2);
...
pub fn bitand(interpreter: &mut Interpreter) {
    gas!(interpreter, gas::VERYLOW);
    pop_top!(interpreter, op1, op2);
    *op2 = op1 & *op2;
}

pub fn bitor(interpreter: &mut Interpreter) {
    gas!(interpreter, gas::VERYLOW);
    pop_top!(interpreter, op1, op2);
    *op2 = op1 | *op2;
}

pub fn bitxor(interpreter: &mut Interpreter) {
    gas!(interpreter, gas::VERYLOW);
    pop_top!(interpreter, op1, op2);
    *op2 = op1 ^ *op2;
}
...
pub fn byte(interpreter: &mut Interpreter) {
    gas!(interpreter, gas::VERYLOW);
    pop_top!(interpreter, op1, op2);
...
pub fn shl<SPEC: Spec>(interpreter: &mut Interpreter) {
...
/// EIP-145: Bitwise shifting instructions in EVM
pub fn shr<SPEC: Spec>(interpreter: &mut Interpreter) {
    check!(interpreter, CONSTANTINOPLE);
    gas!(interpreter, gas::VERYLOW);
    pop_top!(interpreter, op1, op2);
    *op2 >>= as_usize_saturated!(op1);
...
/// EIP-145: Bitwise shifting instructions in EVM
pub fn sar<SPEC: Spec>(interpreter: &mut Interpreter) {
    check!(interpreter, CONSTANTINOPLE);
    gas!(interpreter, gas::VERYLOW);
    pop_top!(interpreter, op1, op2);
